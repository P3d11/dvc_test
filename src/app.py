...
for category in CATEGORIES:
    for category2 in CATEGORIES:
        if(os.path.exists('./src/saved_model/' + category + '_' + category2 + '.h5')):
            print('--FOUND ' + str(aux_mod) + '--')
            models[aux_mod] = load_model('./src/saved_model/' + category + '_' + category2 + '.h5')
            aux_mod += 1
            
models[aux_mod] = load_model('./src/saved_model/all_emotions.h5')
print('--FOUND ' + str(aux_mod) + '--')
